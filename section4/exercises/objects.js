...
var zoo = {
  lions: 4,
  lionNames: ["Cleo", "Aslan", "Simba", "Mufasa"],
};
...
zoo.tigerNames = ["Nelly", "Samson"];
zoo.tigers = 2;
console.log(zoo);

// Change the value for at least one of your animal keys, and log the updated Object.
zoo.tigerNames = ["Carl", "Jesse", "Arthur"];
zoo.tigers = 3;
console.log(zoo);

// Add another animal to the zoo Object, and log the updated Object.
zoo.bearNames = ["Baloo", "Winnie", "Little"];
zoo.bears = 3;
console.log(zoo);
...
var emails = [
  {
    ...
    date: [6, 7, 2021],
    read: false,
    body: "Just wanting to check in. How are you?"
  },
  {
    ...
    date: [6, 13, 2021],
    read: false,
    body: "We've been trying to reach you about your car's extended warranty"
  },
  {
    sender: "example3@gmail.com",
    subject: "Steam sale",
    date: [6, 19, 2021],
    read: false,
    body: "An item from your wishlist is on sale!"
  }
]
console.log(emails);
